...
**Required.** The encrypted OTP target bundle returned by [`useSendMagicLink`](/wallets/hooks/use-send-magic-link). Store it with `otpId` and pass it verbatim to the verify step.
