...
This is useful for React Native apps where `localStorage` is not available — see [React Native Configuration](/wallets/react-native/configuration) for the storage adapters the SDK ships for Expo.
