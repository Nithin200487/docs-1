...
The `mode` option defaults to `'7702'`; set it to `'4337'` for a counterfactual ERC-4337 smart account or `'EOA'` for a plain EOA wallet. See [Connector Options](/wallets/connector-options) for the full list of options.
